...
public enum CacheProperty {
    CACHE_CATEGORY_PRICE(CacheKeys.CATEGORY_PRICE, 300),
    CACHE_BRAND_CATEGORY_PRICE(CacheKeys.BRAND_CATEGORY_PRICE, 300),
    CACHE_CATEGORY_PRODUCT_MIN(CacheKeys.CATEGORY_PRODUCT_MIN, 300),
    CACHE_CATEGORY_PRODUCT_MAX(CacheKeys.CATEGORY_PRODUCT_MAX, 300);
